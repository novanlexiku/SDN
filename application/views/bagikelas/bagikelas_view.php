	...
	$(document).ready(function(){
		...
		$.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
			 ...
			 var table = $("#mytable7a").dataTable({
							 ...
							 ajax: {"url": "<?php echo base_url().'index.php/bagikelas/get_kelas7a_json'?>", "type": "POST"},
									columns: [
												{"data": "siswa_kode"},
												{"data": "siswa_nama"},
												 {"data": "role_nama"},
			 ...
			 var table = $("#mytable7b").dataTable({
							 ...
							 ajax: {"url": "<?php echo base_url().'index.php/bagikelas/get_kelas7b_json'?>", "type": "POST"},
									columns: [
												{"data": "siswa_kode"},
												{"data": "siswa_nama"},
												 {"data": "role_nama"},
			 ...
			 var table = $("#mytable7c").dataTable({
							 ...
							 ajax: {"url": "<?php echo base_url().'index.php/bagikelas/get_kelas7c_json'?>", "type": "POST"},
									columns: [
												{"data": "siswa_kode"},
												{"data": "siswa_nama"},
												 {"data": "role_nama"},
			 ...
			 var table = $("#mytable8a").dataTable({
							 ...
							 ajax: {"url": "<?php echo base_url().'index.php/bagikelas/get_kelas8a_json'?>", "type": "POST"},
									columns: [
												{"data": "siswa_kode"},
												{"data": "siswa_nama"},
												 {"data": "role_nama"},
			 ...
			 var table = $("#mytable8b").dataTable({
							 ...
							 ajax: {"url": "<?php echo base_url().'index.php/bagikelas/get_kelas8b_json'?>", "type": "POST"},
									columns: [
												{"data": "siswa_kode"},
												{"data": "siswa_nama"},
												 {"data": "role_nama"},
			 ...
			 var table = $("#mytable8c").dataTable({
							 ...
							 ajax: {"url": "<?php echo base_url().'index.php/bagikelas/get_kelas8c_json'?>", "type": "POST"},
									columns: [
												{"data": "siswa_kode"},
												{"data": "siswa_nama"},
												 {"data": "role_nama"},
			 ...
			 var table = $("#mytable9a").dataTable({
							 ...
							 ajax: {"url": "<?php echo base_url().'index.php/bagikelas/get_kelas9a_json'?>", "type": "POST"},
									columns: [
												{"data": "siswa_kode"},
												{"data": "siswa_nama"},
												 {"data": "role_nama"},
			 ...
			 var table = $("#mytable9b").dataTable({
							 ...
							 ajax: {"url": "<?php echo base_url().'index.php/bagikelas/get_kelas9b_json'?>", "type": "POST"},
									columns: [
												{"data": "siswa_kode"},
												{"data": "siswa_nama"},
												 {"data": "role_nama"},
			 ...
			 var table = $("#mytable9c").dataTable({
							 ...
							 ajax: {"url": "<?php echo base_url().'index.php/bagikelas/get_kelas9c_json'?>", "type": "POST"},
									columns: [
												{"data": "siswa_kode"},
												{"data": "siswa_nama"},
												 {"data": "role_nama"},
