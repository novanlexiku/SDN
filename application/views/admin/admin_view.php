...
<form id="add-row-form" action="" method="">
 ...
 <!-- Modal Update guru-->
	<form id="add-row-form" action="<?php echo base_url().'index.php/admin/update'?>" method="post">
 ...
 <!-- Modal Hapus guru-->
	<form id="add-row-form" action="<?php echo base_url().'index.php/admin/delete'?>" method="post">
        ...
        $.notify({
            ...
            timer: 500,
						template: '<div class="alert alert-success">'+
  										...
  										'</button>'+
  										'<b>Berhasil</b>  menambah data Admin'+
											'</div>'+'</div>'
		 ...
		 $(document).ready(function(){
			$.notify({
					...
					template: '<div class="alert alert-success">'+
										...
										'<span aria-hidden="true"><i class="material-icons">clear</i></span>'+
										'</button>'+
										'<b>Berhasil</b>  mengubah data Admin'+
										'</div>'+'</div>'
		 ...
		 $(document).ready(function(){
			$.notify({
					...
					template: '<div class="alert alert-success">'+
										...
										'<span aria-hidden="true"><i class="material-icons">clear</i></span>'+
										'</button>'+
										'<b>Berhasil</b>  menghapus data Admin'+
										'</div>'+'</div>'
		...
		$.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
			 ...
			 var table = $("#mytable").dataTable({
					 initComplete: function() {
							 ...
							 processing: true,
							 serverSide: true,
							 ajax: {"url": "<?php echo base_url().'index.php/admin/get_guru_json'?>", "type": "POST"},
									columns: [
												{"data": "guru_kode"},
												{"data": "guru_nama"},
												{"data": "guru_username"},
